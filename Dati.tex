...
\newcommand{\prospettoSettimanale}{
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Formazione personale sulle tecnologie utilizzate;
        \end{itemize}
        \item \textbf{Terza Settimana - Interazione Hardware Software} 
        \begin{itemize}
            \item Adattamento del software su Arduino per il nuovo modulo;
        \end{itemize}
        \item \textbf{Quarta Settimana - Database} 
        \begin{itemize}
            \item Adattamento del database esistente per l'aggiunta del nuovo modulo;
        \end{itemize}
        ...
        \begin{itemize}
            \item Pianificazione dello sviluppo della piattaforma online;
